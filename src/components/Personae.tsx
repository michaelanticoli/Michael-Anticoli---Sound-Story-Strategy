...
const personae: PersonaData[] = [
  {
    ...
    audioSrc: import.meta.env.BASE_URL + "audio/ang_bocca_demo.mp3",
    image: angBoccaImage,
    icon: Mic2,
  ...
  },
  {
    ...
    audioSrc: import.meta.env.BASE_URL + "audio/silas_gogh_demo.mp3",
  ...
  },
  {
    ...
    audioSrc: import.meta.env.BASE_URL + "audio/rcc_demo.mp3",
  ...
  },
  {
    ...
    audioSrc: import.meta.env.BASE_URL + "audio/bbk_demo.mp3",
  ...
  },
  {
    ...
    audioSrc: import.meta.env.BASE_URL + "audio/nadia_demo.mp3",
  ...
  },
  {
    ...
    audioSrc: import.meta.env.BASE_URL + "audio/amon_demo.mp3",
